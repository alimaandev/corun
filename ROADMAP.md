...
| User-generated content (editor, browser, URL share) | v1.0 |
| Speed Run & Survival game modes | v1.0 |
| Social features (Web Share API, leaderboard) | v1.0 |
| Accessibility + i18n (focus traps, ARIA, EN/ES/FR) | v1.0 |
| PWA (install prompt, offline indicator, service worker) | v1.0 |
| Code splitting + performance optimization | v1.0 |
| Guest/demo auth mode | v1.0 |
...
## 📅 Short-Term (v1.2 — v1.4)

- [ ] Sound effects toggle (mute/unmute) in HUD
...
- [ ] Full save-state sync via Supabase
- [ ] Plugin API for third-party challenge integrations
...
<p align="center">
  <sub>This roadmap is a living document. Priorities shift based on community feedback.</sub>
  <br />
  <sub>Have a suggestion? <a href="https://github.com/alimaandev/corun/issues/new?labels=enhancement&template=feature_request.yml">Open a feature request</a></sub>
</p>
